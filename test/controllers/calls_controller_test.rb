...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { client_id: @call.client_id, screenplay_id: @call.screenplay_id, status: @call.status, user_id: @call.user_id } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { client_id: @call.client_id, screenplay_id: @call.screenplay_id, status: @call.status, user_id: @call.user_id } }
