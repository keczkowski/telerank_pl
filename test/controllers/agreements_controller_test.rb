...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { body: @agreement.body, client_id: @agreement.client_id, name: @agreement.name, partner_id: @agreement.partner_id, screenplay_id: @agreement.screenplay_id, user_id: @agreement.user_id } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { body: @agreement.body, client_id: @agreement.client_id, name: @agreement.name, partner_id: @agreement.partner_id, screenplay_id: @agreement.screenplay_id, user_id: @agreement.user_id } }
