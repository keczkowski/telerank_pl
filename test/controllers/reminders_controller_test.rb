...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { body: @reminder.body, client_id: @reminder.client_id, name: @reminder.name, remind_at: @reminder.remind_at, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { body: @reminder.body, client_id: @reminder.client_id, name: @reminder.name, remind_at: @reminder.remind_at, user_id: @reminder.user_id } }
