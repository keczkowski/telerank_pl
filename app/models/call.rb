class Call < ApplicationRecord
  ...
  def create_event1
    Event.create(name: "Dodano nową rozmowę według scenariusza: #{self.screenplay.name}", body: self.inspect, client_id: self.client_id, user_id: self.user_id, call_id: self.id)
  end
